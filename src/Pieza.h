...
public:
    ...
    //NUEVAFUNCION ademas de actualizar cada pieza
    virtual bool puedeatacar(int destX, int destY, class Pieza* tablero[5][5]) = 0;//devuelve si la pieza puede atacar al rey para comprobar el jaque
    ...
    virtual int getValor() const = 0; // devuelve el valor asignado a cada pieza (virtual puro)
};
